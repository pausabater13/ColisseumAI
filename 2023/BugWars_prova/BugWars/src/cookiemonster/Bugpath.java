...
/**
 * This class is just a copy-paste from the (very very rough) Bugpath implementation posted in our website.
 * We added that if the unit cannot move it doesn't even try (otherwise if the user forgets to add this clause
 * it might detect all adjacent locations as obstacles).
 */
...
public class Bugpath {
    ...
    void moveTo(Location target){
        ...
        //Can't move? -> Return! This was not in the original file.
